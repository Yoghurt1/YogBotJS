...
import { SessionedRequest, SessionedMessage, Sessioned } from './baseMessage'

export interface Weather extends Sessioned {
  /** Air temperature (°C). */
...
export interface WeatherMessage extends Weather, SessionedMessage {}
